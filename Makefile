...
kernel: $(KERNEL_ASM_OBJ) $(KERNEL_MAIN_OBJ) $(TERMINAL_OBJ) $(MEMORY_OBJ) $(PANIC_OBJ) $(LOGGER_OBJ) $(INTERRUPT_STUBS_OBJ) $(IDT_OBJ) $(INTERRUPTS_OBJ) $(EXCEPTIONS_OBJ) $(IO_OBJ) $(PIC_OBJ) $(KEYBOARD_OBJ) $(CPU_OBJ) $(STRING_OBJ) $(CONSOLE_OBJ) $(SHELL_OBJ)
	$(LD) -T $(LINKER_SCRIPT) -o $(KERNEL_ELF) $(KERNEL_ASM_OBJ) $(KERNEL_MAIN_OBJ) $(TERMINAL_OBJ) $(MEMORY_OBJ) $(PANIC_OBJ) $(LOGGER_OBJ)  $(INTERRUPT_STUBS_OBJ) $(IDT_OBJ) $(INTERRUPTS_OBJ) $(EXCEPTIONS_OBJ) $(IO_OBJ) $(PIC_OBJ) $(KEYBOARD_OBJ) $(CPU_OBJ) $(STRING_OBJ) $(CONSOLE_OBJ) $(SHELL_OBJ)
