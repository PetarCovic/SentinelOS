...
kernel: $(KERNEL_ASM_OBJ) $(KERNEL_MAIN_OBJ) $(TERMINAL_OBJ) $(MEMORY_OBJ) $(PANIC_OBJ) $(LOGGER_OBJ) $(INTERRUPT_STUBS_OBJ) $(IDT_OBJ) $(INTERRUPTS_OBJ)
	$(LD) -T $(LINKER_SCRIPT) -o $(KERNEL_ELF) $(KERNEL_ASM_OBJ) $(KERNEL_MAIN_OBJ) $(TERMINAL_OBJ) $(MEMORY_OBJ) $(PANIC_OBJ) $(LOGGER_OBJ)  $(INTERRUPT_STUBS_OBJ) $(IDT_OBJ) $(INTERRUPTS_OBJ)
